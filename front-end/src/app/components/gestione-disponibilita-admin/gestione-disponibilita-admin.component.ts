...
@Component({
  selector: 'app-gestione-disponibilita-admin',
  templateUrl: './gestione-disponibilita-admin.component.html',
  styleUrls: ['./gestione-disponibilita-admin.component.scss'],
})
export class GestioneDisponibilitaAdminComponent {
  campi: Campo[] = [];
